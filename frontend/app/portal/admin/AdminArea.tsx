...
type AdminTab = "status" | "pc" | "session" | "people" | "notice" | "clean";
...
export default function AdminArea() {
  ...
  }, [loadStatus, loadNodes, loadUsers, loadSessions, loadContainers]);
          ...
          {sessions.length === 0 ? (
            ...
            sessions.map((se) => (
              <div className={s.adminRow} key={se.id}>
                ...
                <span>{formatDateTime(se.status === "suspended" ? se.delete_after : se.expires_at)}</span>
